...
export const ENV_DISPLAY = [
  ...
  { env: 'PSP_NPSSO',      category: 'credentials', group: 'PlayStation Plus', label: 'NPSSO token',
    note: 'Optional. 64-char SSO token for form-free silent re-auth (sidesteps the login form/bot wall). Get it by logging in at playstation.com then visiting ca.account.sony.com/api/v1/ssocookie. ~2-month life; auto-refreshed once set.' },
