...
export const ENV_DISPLAY = [
  ...
  { env: 'PSP_EMAIL',      category: 'credentials', group: 'PlayStation Plus', label: 'Email' },
  { env: 'PSP_PASSWORD',   category: 'credentials', group: 'PlayStation Plus', label: 'Password' },
  { env: 'PSP_OTPKEY',     category: 'credentials', group: 'PlayStation Plus', label: 'OTP key' },
